...
class Armadura():
    ...
    def config_file(self):
        ...
        if "FORA_DO_HORARIO_GERAL" in self.file:
            ...
            if True:
                SEMOSP = ["CA26", "CA70", "CA76", "CA80", "CA100", "CA104", "CA109", "CA121", "CA126", "CA130", "CA134", "CA137", "CA144",
                          "CB64", "CB72", "CB99", "CB100", "CB102", "CB129", "CB129", "CB133", "CB137", "CB170", "CB173", "CB192", "CB208", 
                          "CB225", "CB230", "CB235", "CB256", "CB257", "CB258", "CB264", "CB271"]
